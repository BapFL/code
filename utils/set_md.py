...
from data.femnist import get_femnist_dataloaders
from data.cifar10 import get_cifar10_dataloaders

# models
from models.MnistNet import MnistNet
from models.FashionmnistNet import FashionmnistNet
from models.FemnistNet import FemnistNet
from models.Cifar10 import vgg11
...
def setup_datasets(config):
    ...
    if config.dataset == 'mnist':
        ...
        train_loaders, test_loaders, attack_test_loaders = get_femnist_dataloaders(batch_size=batch_size,
                                                                                   transform=transform,
                                                                                   poison_swap_label=config.poison_swap_label)
...
def select_model(config):
    ...
    if model_name == 'mnist':
        ...
        model = vgg11(algorithm=config.algorithm, num_share_layers=config.num_share_layers)
    else:
